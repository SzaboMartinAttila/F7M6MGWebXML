...
public class DomWritef7m6mg {
    public static void main(String[] args) {
        try {
            // XML dokumentum beolvasása
            DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
            DocumentBuilder builder = factory.newDocumentBuilder();
            Document document = builder.parse("hallgatok.xml");
            ...
            StreamResult result = new StreamResult("hallgatok1.xml");
            transformer.transform(source, result);
            
            System.out.println("Az XML fájl sikeresen kiírva: hallgatok1.xml");
